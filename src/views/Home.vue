                    ...
                    <nav class="relative max-w-7xl mx-auto flex items-center justify-between px-4 sm:px-6" aria-label="Global">
                        <div class="flex items-center flex-1">
                            ...
                            <div class="hidden space-x-10 md:flex md:ml-10">
                                <a href="javascript://" class="font-medium text-white hover:text-gray-300">Product</a>

                                <a href="javascript://" class="font-medium text-white hover:text-gray-300">Features</a>

                                <a href="javascript://" class="font-medium text-white hover:text-gray-300">Marketplace</a>

                                <a href="javascript://" class="font-medium text-white hover:text-gray-300">Company</a>
                            </div>
                        </div>
                        <div class="hidden md:flex">
                            <a href="javascript://" class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-gray-600 hover:bg-gray-700">
                                Connect Wallet
                            </a>
                        </div>
                    </nav>
                    ...
                    <div class="mx-auto max-w-7xl">
                        <div class="lg:grid lg:grid-cols-12 lg:gap-8">
                            <div class="px-4 sm:px-6 sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left lg:flex lg:items-center">
                                <div>
                                    <a href="javascript://" class="inline-flex items-center text-white bg-gray-900 rounded-full p-1 pr-2 sm:text-base lg:text-sm xl:text-base hover:text-gray-200">
                                ...
                                <div class="bg-white sm:max-w-md sm:w-full sm:mx-auto sm:rounded-lg sm:overflow-hidden">
                                    ...
                                    <div class="px-4 py-6 bg-gray-50 border-t-2 border-gray-200 sm:px-10">
                                        <p class="text-xs leading-5 text-gray-500">
                                            By signing up, you agree to our <a href="javascript://" class="font-medium text-gray-900 hover:underline">Terms</a>, <a href="javascript://" class="font-medium text-gray-900 hover:underline">Data Policy</a> and
                                            <a href="javascript://" class="font-medium text-gray-900 hover:underline">Cookies Policy</a>.
                                        </p>
                                    </div>
                                </div>
                            </div>
