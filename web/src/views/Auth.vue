...
export default {
    ...
    created: function () {
        ...
        (function () {
          ...
          // Generate request
          btnGenReq.addEventListener("click", function () {
          ...
          btnRegister.addEventListener("click", function () {
            try {
              ...
              u2f.register(value.appId, [{
                ...
                console.log(reserved, signature);
              });
            } catch (e) {
              console.error("No request specified, generate or input one manually");
            }
    ...
    mounted: function () {
        ...
        u2f.formatRegisterRequest_ =
          ...
          if (js_api_version === undefined || js_api_version < 1.1) {
            // Adapt request to the 1.0 JS API
            for (i = 0; i < registerRequests.length; i++) {
        ...
        u2f.WrappedAuthenticatorPort_.prototype.onRequestUpdate_ =
          ...
          if (Object.prototype.hasOwnProperty.call(messageObject, 'data')) {
          ...
          console.log(intentUrl, errorCode);
        };
         ...
         * @param {function({data: Object})} handler
         */
        u2f.WrappedIosPort_.prototype.addEventListener = function(eventName) {
          var name = eventName.toLowerCase();
          if (name !== 'message') {
